...
public class Give {
    ...
    public Give(LocalDateTime entrada, LocalDateTime saida, Conductor conductor, Vehicle vehicle, Long tempo, Long tempoParaDesconto, BigDecimal ValueTotal, Long desconto) {
        this.enter = entrada;
        this.exit = saida;
